...
function filterUnfundedOnly() {
  ...
  // console.log(unfundedGames); // to see how many unfunded games
}
...
function filterFundedOnly() {
  ...
  // console.log(fundedGames); // to see how many unfunded games
}
...
const totalGames = GAMES_JSON.length; // to get total games

const displayDescription = `
A total of $${totalAmountRaised.toLocaleString()} has been raised for ${totalGames} ${
...
descriptionElement.innerText = displayDescription;
...
// implement extra feature search bar
document.getElementById("search-bar").addEventListener("input", (event) => {
  ...
  if (filteredGames.length === 0) {
    ...
    noGamesMessage.innerText = "Game not found";
    noGamesMessage.style.fontSize = "2rem";
    noGamesMessage.style.color = "black";
    gamesContainer.appendChild(noGamesMessage);
  } else {
    // If games are found, display them
